...
unet.load_weights('model/unet-filt-model/unet-filt-0.58.mdl')
cnn3d = cnn3d([49, 49, 49, 1])
cnn3d.load_weights('model/chp29')

#------------------------------------------------------------------------------------------
#read in the mhd file and csv
#train_path = 'dir05-08/'
#train_path = '/media/izm/Mix/fjj-test/'
train_path = '/media/izm/Normal/train_subset00-04/'
file_list = glob(train_path + "*020.mhd")
